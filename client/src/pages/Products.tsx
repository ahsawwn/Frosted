      ...
      <div className="flex justify-between items-center glass-panel p-6 rounded-[2.5rem] border-2 border-white/5 shrink-0">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl font-black text-text-main tracking-tighter uppercase italic leading-none">
              frosted <span className="text-brand">Product List</span>
            </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="flex items-center gap-2.5 px-6 py-4 bg-panel border-2 border-border-frosted rounded-2xl font-black text-[10px] uppercase tracking-widest text-text-muted hover:text-brand hover:border-brand transition-all"
          >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-text-main/80 backdrop-blur-xl z-[100] flex items-center justify-center p-8">
          <div className="bg-surface w-full max-w-3xl rounded-[4rem] shadow-glow overflow-hidden relative border-2 border-brand/20">
            <div className="flex justify-between items-center p-12 border-b-2 border-border-frosted backdrop-blur-3xl bg-surface/50">
              <div>
               ...
               <div className="grid grid-cols-2 gap-10">
                  <div className="space-y-4">
                    ...
                    <input 
                      ...
                      className="w-full bg-panel border-2 border-border-frosted rounded-3xl py-6 px-8 outline-none focus:border-brand font-black text-sm uppercase transition-all"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full bg-panel border-2 border-border-frosted rounded-3xl py-6 pl-16 pr-8 outline-none focus:border-brand font-black text-sm uppercase transition-all"
                        placeholder="0.00"
                        required
                      />
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full bg-panel border-2 border-border-frosted rounded-3xl py-6 pl-16 pr-8 outline-none focus:border-brand font-black text-sm transition-all"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <select 
                        ...
                        className="w-full bg-panel border-2 border-border-frosted rounded-3xl py-6 pl-16 pr-8 outline-none focus:border-brand font-black text-sm uppercase cursor-pointer"
                        required
                      >
      ...
      {isCategoryModalOpen && (
        <div className="fixed inset-0 bg-text-main/80 backdrop-blur-xl z-[100] flex items-center justify-center p-8">
           <div className="bg-surface w-full max-w-md rounded-[3rem] shadow-glow border-2 border-brand/20 overflow-hidden">
              <div className="p-8 border-b-2 border-border-frosted flex justify-between items-center">
