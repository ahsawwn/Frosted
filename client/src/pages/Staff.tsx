        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl font-black text-text-main tracking-tighter uppercase italic leading-none">
              frosted <span className="text-brand">Operators</span>
            </h1>
            ...
            <tbody>
              {loading ? (
                ...
                <tr key={member.id} className="group hover:bg-surface transition-all">
                  <td className="px-8 py-6 bg-panel/30 first:rounded-l-2xl border-y-2 border-l-2 border-transparent group-hover:border-border-frosted border-l-transparent group-hover:bg-surface">
                    <div className="flex items-center gap-5">
                  ...
                  <td className="px-8 py-6 bg-panel/30 border-y-2 border-transparent group-hover:border-border-frosted group-hover:bg-surface">
                  ...
                  <td className="px-8 py-6 bg-panel/30 last:rounded-r-2xl border-y-2 border-r-2 border-transparent group-hover:border-border-frosted group-hover:bg-surface text-right border-r-transparent">
                    <div className="flex items-center justify-end gap-3">
                      <button className="p-3 bg-surface text-text-muted hover:text-brand hover:border-brand border-2 border-border-frosted rounded-xl transition-all shadow-sm">
                        <Fingerprint size={18} />
                      </button>
                      <button onClick={() => deleteStaff(member.id)} className="p-3 bg-surface text-text-muted hover:text-red-500 hover:border-red-500 border-2 border-border-frosted rounded-xl transition-all shadow-sm">
                        <Trash2 size={18} />
                      </button>
                    </div>
                  </td>
                 ...
                 <div className="grid grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                       ...
                       <input 
                         ...
                         className="w-full bg-panel border-2 border-border-frosted rounded-2xl py-4 px-6 outline-none focus:border-brand font-black text-xs uppercase tracking-widest"
                    ...
                    <div className="space-y-2">
                       ...
                       <div className="relative group">
                          ...
                          <input 
                            ...
                            className="w-full bg-panel border-2 border-border-frosted rounded-2xl py-4 pl-14 pr-6 outline-none focus:border-brand font-black text-xs"
                            placeholder="********"
                            required
                          />
                       </div>
                    ...
                    <div className="space-y-2">
                       ...
                       <div className="relative group">
                          ...
                          <select 
                            ...
                            className="w-full bg-panel border-2 border-border-frosted rounded-2xl py-4 pl-14 pr-6 outline-none focus:border-brand font-black text-[10px] uppercase tracking-widest appearance-none cursor-pointer"
                          >
