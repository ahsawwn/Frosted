    ...
    <div className="w-full h-full flex flex-col space-y-5 theme-transition overflow-hidden">
      ...
      <div className="flex justify-between items-center glass-panel p-5 rounded-[2.5rem] border-2 border-white/5 shrink-0">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl font-black text-text-main tracking-tighter uppercase italic leading-none">
              Oftsy <span className="text-brand">Hub</span>
            </h1>
        ...
        <div className="flex items-center gap-10">
           <div className="hidden xl:flex items-center gap-8 border-r-2 border-border-oftsy pr-10">
          ...
          <button onClick={fetchDashboardData} className="bg-panel p-3 rounded-xl text-text-muted hover:text-brand transition-all border-2 border-border-oftsy">
      ...
      <div className="grid grid-cols-12 gap-5 flex-1 min-h-0">
        ...
        <div className="col-span-8 industrial-card p-8 flex flex-col min-h-0 border-2 border-white/5">
          <div className="flex justify-between items-center mb-6 shrink-0">
            ...
            <div className="flex bg-panel px-3 py-1.5 rounded-full border border-border-oftsy items-center gap-2">
            ...
            {recentOrders.map((order) => (
              ...
              >
                <div className="flex items-center gap-6">
                  <div className="w-12 h-12 bg-surface rounded-xl border-2 border-border-oftsy flex items-center justify-center font-black text-[10px] text-text-muted group-hover:text-brand group-hover:border-brand transition-all shadow-sm">
        ...
        <div className="fixed inset-0 bg-text-main/80 backdrop-blur-3xl z-[100] flex items-center justify-end p-5 font-mono animate-in slide-in-from-right-full duration-700">
           <div className="w-full max-w-xl h-full bg-surface rounded-[3.5rem] shadow-glow border-l-4 border-brand p-12 flex flex-col overflow-hidden relative">
              ...
              <div className="flex justify-between items-start mb-16 relative z-10">
                 ...
                 <button onClick={() => setSelectedOrder(null)} className="p-4 bg-panel rounded-[1.5rem] text-text-muted hover:text-brand transition-all border-2 border-border-oftsy">
                    <Activity size={24} />
                 </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto no-scrollbar space-y-12 relative z-10">
                 <div className="space-y-6">
                    <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.4em] border-b-2 border-border-oftsy pb-4">Items Ordered</p>
                 ...
                 <div className="grid grid-cols-2 gap-8">
                    <div className="p-8 bg-panel/50 rounded-[2.5rem] border-2 border-border-oftsy">
                    ...
                    <div className="p-8 bg-panel/50 rounded-[2.5rem] border-2 border-border-oftsy text-right">
                 ...
                 <div className="space-y-4 pt-10 border-t-2 border-dashed border-border-oftsy">
...
const StatusBadge = ({ icon, label, value }: any) => (
  <div className="flex items-center gap-3">
    <div className="p-2 bg-panel rounded-xl border-2 border-border-oftsy">{icon}</div>
    <div>
