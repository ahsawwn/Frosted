...
const Settings = () => {
  ...
  const [settings, setSettings] = useState({
    storeName: 'Oftsy Creamery & Bakery',
    logoUrl: '',
    themeColor: '#db2777',
    currency: 'PKR',
                    ...
                    {themes.map((opt) => (
                      <button
                        ...
                        className={`relative p-5 rounded-[2rem] border-2 transition-all duration-500 group flex flex-col items-start ${
                          theme === opt.id ? 'border-brand bg-brand/5 shadow-[0_20px_50px_rgba(219,39,119,0.1)]' : 'border-border-oftsy bg-panel/30 hover:border-brand/40'
                        }`}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-8">
                       <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full bg-panel border-2 border-border-oftsy rounded-xl py-4 px-6 outline-none font-black text-text-main focus:border-brand transition-all uppercase text-[10px]" 
                          />
                       </div>
                       <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full bg-panel border-2 border-border-oftsy rounded-xl py-4 px-6 outline-none font-black text-text-main focus:border-brand transition-all text-[10px]" 
                            placeholder="https://oftsy.io/assets/logo.png"
                          />
                       </div>
                    </div>
                </section>
             ...
             <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
                <section className="industrial-card p-6 border-2 border-white/5 rounded-[2.5rem] scale-[0.98]">
                   ...
                   <div className="grid grid-cols-12 gap-8">
                      <div className="col-span-12 lg:col-span-7 space-y-6">
                        <div className="grid grid-cols-2 gap-6">
                           <div className="space-y-2">
                              ...
                              <select 
                                ...
                                className="w-full bg-panel border-2 border-border-oftsy rounded-xl py-3 px-4 outline-none font-black text-[10px] uppercase tracking-widest"
                              >
                           ...
                           <div className="space-y-2">
                              ...
                              <input 
                                ...
                                className="w-full bg-panel border-2 border-border-oftsy rounded-xl py-3 px-4 outline-none font-black text-[10px] uppercase"
                                placeholder="11px"
                              />
                           </div>
                        </div>
                        ...
                        <div className="space-y-2">
                           ...
                           <textarea 
                             ...
                             className="w-full bg-panel border-2 border-border-oftsy rounded-xl py-3 px-6 outline-none font-black text-[10px] uppercase"
                           />
                        </div>
                      ...
                      <div className="col-span-12 lg:col-span-5 bg-white p-6 rounded-xl text-black shadow-lg border border-border-oftsy max-h-[400px] overflow-hidden flex flex-col items-center">
                         <div className="text-center w-full" style={{ fontFamily: settings.receiptFont, fontSize: settings.receiptFontSize }}>
                            <p className="font-black text-lg">OFTSY</p>
          ...
          {activeTab === 'Security' && (
             <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <section className="industrial-card p-6 border-2 border-white/5 rounded-[2.5rem]">
                   ...
                   <div className="bg-panel border-2 border-border-oftsy rounded-[2rem] p-8">
