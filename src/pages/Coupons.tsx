        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl font-black text-text-main tracking-tighter uppercase italic leading-none">
              Oftsy <span className="text-brand">Vouchers</span>
            </h1>
          ...
          {filtered.map(c => (
            <div key={c.id} className="industrial-card p-6 rounded-[2.25rem] flex flex-col justify-between border-2 border-white/5 relative group overflow-hidden bg-panel/20">
               <div className="flex justify-between items-start mb-6">
                  ...
                  <button onClick={() => deleteCoupon(c.id)} className="p-2.5 bg-panel/50 rounded-xl text-text-muted hover:text-red-500 transition-all border border-border-oftsy hover:border-red-500">
                     <Trash2 size={16} />
                  </button>
               </div>
              ...
              <form onSubmit={handleSubmit} className="p-10 space-y-8">
                 <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-panel border-2 border-border-oftsy rounded-2xl py-4 px-6 outline-none focus:border-brand font-black text-sm uppercase tracking-widest"
                 ...
                 <div className="grid grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                       ...
                       <input 
                         ...
                         className="w-full bg-panel border-2 border-border-oftsy rounded-2xl py-4 px-6 outline-none focus:border-brand font-black text-[10px] uppercase"
                       />
                    </div>
                 </div>
